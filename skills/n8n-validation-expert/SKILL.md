...
description: Validation-debug specialist for n8n workflows. Trigger on validate_node/validate_workflow errors, warnings, false positives, profile selection, or iterative fix-and-revalidate loops.
---
